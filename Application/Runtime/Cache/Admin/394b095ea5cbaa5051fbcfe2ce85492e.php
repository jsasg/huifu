...
<body>
	...
	<div class="main-title">
		<h4 class="title-text floatL">广告列表</h4>
		<div class="title-button floatR">
			<a href="<?php echo U('Advert/add');?>" class="btn btn-danger">
			...
			<table class="table margin-bottom-0">
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td><?php echo ($vo['advert_name']); ?></td>
							<td><?php echo ($vo['advert_sort']); ?></td>
							<td>
							...
							<td>
								<a href="<?php echo U('Advert/add',array('id'=>$vo['id']));?>">
									编辑
								</a>|
								<a href="<?php echo U('Advert/delete',array('id'=>$vo['id']));?>">
									删除
								</a>
							</td>
