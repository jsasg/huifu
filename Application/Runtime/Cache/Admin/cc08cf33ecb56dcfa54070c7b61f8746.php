...
<body>
	...
	<div class="main-title">
		...
		<div class="title-button floatR">
			...
			<a href="<?php echo U('productClass/index');?>" class="btn btn-danger">
    ...
    <div class="main-content margin-bottom-10">
		...
		<form action="<?php echo U('ProductClass/insert',array('id'=>$_GET['id']));?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="insertForm">
			...
			<div class="border-dashed">
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <select class="form-control" name="parent_id" id="parent">
                            ...
                            <?php if(is_array($parent)): $i = 0; $__LIST__ = $parent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pid): $mod = ($i % 2 );++$i;?><option value="<?php echo ($pid['id']); ?>" class="padding-left-10" <?php if($pid['id'] == $class['parent_id']): ?>selected="selected"<?php endif; ?>><?php echo ($pid['class_name']); ?></option>
                                <?php if(is_array($pid[sub])): $i = 0; $__LIST__ = $pid[sub];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$su): $mod = ($i % 2 );++$i;?><option value="<?php echo ($su['id']); ?>" class="padding-left-10" <?php if($su['id'] == $class['parent_id']): ?>selected="selected"<?php endif; ?>>&emsp;|-<?php echo ($su['class_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
				</div>
				<div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="class_name" name="class_name" value="<?php echo ($class['class_name']); ?>" placeholder="请输入分类名称">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                         <?php if($class['picture'] == false): ?><input type="file" id="picture" name="picture" value="<?php echo ($class['picture']); ?>" placeholder="请上传分类缩略图">
                         <?php else: ?>
                             <img src="/huifu/Public/Uploads/images/<?php echo ($class['picture']); ?>" class="height100" alt="">
                             <a href="<?php echo U('ProductClass/delPicture',array('id'=>$class['id']));?>">删除</a><?php endif; ?>
                    </div>
                    <div class="floatL height34 padding-top-10">
                        <span class="colorR font24">*</span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="sort" name="sort" value="<?php echo ($class['sort']); ?>" placeholder="请为分类排序">
                    </div>
                    <div class="floatL height34 padding-top-10">
                        <span class="colorR font24">*</span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <label class="radio-inline">
                            <input type="radio" name="is_open" id="status1" value="0" <?php if($class['is_open'] == 0): ?>checked="checked"<?php endif; ?>> 否
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="is_open" id="status2" value="1" <?php if($class['is_open'] == 1): ?>checked="checked"<?php endif; ?>> 是
                        </label>
                    </div>
                    <div class="floatL height34 padding-top-10">
                        <span class="colorR font24">*</span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <textarea class="form-control" name="remark" rows="3"><?php echo ($class['remark']); ?></textarea>
                    </div>
				</div>
			</div>
		</form>
