...
<body>
	...
	<div class="main-title">
		...
		<div class="title-button floatR">
			<a href="<?php echo U('Article/add');?>" class="btn btn-danger">
	...
	<div class="main-content">
		<form action="<?php echo U('Article/delete');?>" method="get" id="deleterForm">
			...
			<table class="table margin-bottom-0">
				<thead>
					<tr class="active">
						...
						<th>
                            <span>新增时间</span>
                            <?php if(($_GET['sort_time'] == 'up') || ($_GET['sort_time'] == false)): ?><a href="<?php echo U('Article/index',array('sort_time'=>'down'));?>">
                            <?php else: ?>
                                <a href="<?php echo U('Article/index',array('sort_time'=>'up'));?>"><?php endif; ?>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<a href="<?php echo U('Article/add',array('id'=>$vo['id']));?>">
									编辑
								</a>|
								<a href="<?php echo U('Article/delete',array('id'=>$vo['id']));?>">
									删除
								</a>
							</td>
