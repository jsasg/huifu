			...
			<table class="table margin-bottom-0">
				<thead>
					<tr class="active">
                        ...
                        <th>
                            <span>发布时间</span>
                            <?php if(($_GET['sort_time'] == 'up') || ($_GET['sort_time'] == false)): ?><a href="<?php echo U('RealTimeNews/index',array('sort_time'=>'down'));?>">
                            <?php else: ?>
                                <a href="<?php echo U('RealTimeNews/index',array('sort_time'=>'up'));?>"><?php endif; ?>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<a href="<?php echo U('RealTimeNews/delete',array('id'=>$vo['id']));?>">
									删除
								</a>
							</td>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  	<div class="modal-dialog" role="document">
	    		<div class="modal-content">
	      			...
	      			<form action="<?php echo U('RealTimeNews/index');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	      			<div class="modal-body">
					<div class="form-group">
					    	<label for="title" class="col-sm-2 control-label">标题：</label>
					    	<div class="col-sm-9">
					      		<input type="text" class="form-control" id="title" name="title" value="<?php echo ($new['title']); ?>" placeholder="平台用户名">
					    	</div>
					</div>
					<div class="form-group">
					    	<label for="content" class="col-sm-2 control-label">内容：</label>
					    	<div class="col-sm-9">
					      		<textarea type="text" class="form-control" rows="6" name="content" value="<?php echo ($new['content']); ?>" placeholder="内容..." ></textarea>
					    	</div>
					</div>
				</div>
